<x-app-layout>
    ...
    {{-- <h1 class="text-3xl font-bold mb-6 text-center">Paste Table Data</h1> --}}
    ...
    <div class="flex flex-col md:flex-row gap-6 w-full max-w-6xl mx-auto">
        ...
        <!-- Form -->
        <form action="/table" method="POST" id="tableForm" class="w-full bg-white shadow-lg rounded-lg p-6 flex-1">
            @csrf
    ...
    <script>
        function generateForm(clipboardData) {
            ...
            var columnNames = ['customer', 'shipping_id', 'number', 'number', 'place', 'hamza']; // Custom column names
